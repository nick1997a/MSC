...
def compute_acck( model_name, alldata,all_mention_embeddings, entities_embeddings,umls_entinames):
    ...
    our_model.load_state_dict(torch.load('/home/gan/CODES/CrossEncoder/AAANEW/crossencoder/best_model_bt52.pth'))
    ...
    for i in tqdm(range(0,len(all_retrieved_topK))):
        ...
        if correct_umls_name in retrieved_topK_names[:1]:
            accuracy.append(1)
        else:
            ...
            second_indice_info = [umls_entinames[k] for k in ranked_indices[:1]]
